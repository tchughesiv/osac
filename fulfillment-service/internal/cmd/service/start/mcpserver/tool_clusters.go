...
type CreateClusterFromCatalogItemInput struct {
	...
	Set         []string `json:"set,omitempty" jsonschema:"optional key=value field overrides, matching paths governed by the catalog item's fields or template_parameters policies (dot notation)"`
}
...
func handleCreateClusterFromCatalogItem(
	...
	return func(
		...
		// The service resolves catalog-item references by ID or name.
		...
		// The service derives tenant and creator from the caller identity.
